...
export default function SponsorPage({ showDraft }: SponsorPageProps) {
  ...
  return (
    <div className="">
      ...
      {
        <div>
          <h3 className={`mb-8 text-2xl font-bold divider ${sponsorVariants["Bronze"].divider} `}>
            Bronze Sponsors
          </h3>
          <div
            className={`grid my-8 px-4 sm:px-6 lg:px-8 mt-8 mb-12 gap-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4`}
          >
      ...
      <Container>
        <div className="hero min-h-[10vh] lg:min-h-[20vh]">
          <div className="hero-content p-0 max-w-full text-center">
            <h1 className="text-4xl lg:leading-relaxed lg:text-4xl font-bold">
