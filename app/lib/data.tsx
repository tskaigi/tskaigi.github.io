...
export const sponsorList: SponsorList = {
  Platinum: [
    {
      ...
      links: [
        ...
        { href: "https://recruit.leverages.jp/recruit/engineer/", text: "エンジニア採用" },
      ],
    },
    {
      name: "アセンド株式会社",
      description: (
        <>
          ...
          ■ アセンドとTypeScript
          アセンドは社会課題を解決するプロダクトエンジニア組織を目指して、Frontend/Backend/IaCの全てをTypeScriptで統一しました。TSでの言語統一により、全エンジニアがフルスタックに開発し、顧客業務やドメインに深く寄り添いプロダクト価値に拘った開発を進めています。開発生産性は6deploys/dayと高い環境であり、少数チームでありながらサービスは案件管理や労務・車両管理といった多岐にわたる複数プロダクトを展開し、運送会社の全ての業務のデジタル化を推進しています。2023年12月にはシリーズAの資金調達を実施し、より多くの運送会社に更なる機能・価値を届けるため、仲間を募集しています。
      ...
      links: [
        ...
        { href: "https://product.career.ascendlogi.co.jp/", text: "エンジニア採用サイト" },
        { href: "https://note.com/niwa_takeru/n/n0ae4acf2964d", text: "プロダクトエンジニアに関して" },
      ],
    },
    {
      name: "株式会社ドワンゴ",
    ...
    },
    {
      ...
      description: (
        <>
          Progate は、初心者から始められるプログラミングのオンライン学習サービスである Progate や、自分の環境をつかって実務に近い開発経験を積める Progate Path といったサービスを提供しています。
    ...
    },
    {
      ...
      logoLink: "https://scrapbox.io/helpfeel-dev-careers/%E9%96%8B%E7%99%BA%E9%83%A8_%E6%8E%A1%E7%94%A8%E6%83%85%E5%A0%B1",
      links: [
        { href: "https://twitter.com/Helpfeeltech", text: "@Helpfeel_tech", },
        { href: "https://blog.notainc.com/", text: "Helpfeel Developers' Blog" },
      ],
    },
  ],
  Gold: [
    {
      ...
      links: [
        ...
        { href: "https://intro.dr-ubie.com/", text: "「ユビーメディカルナビ」" },
      ],
    },
    {
      name: "ファストドクター株式会社",
    ...
    },
    {
      ...
      links: [
        ...
        { href: "https://developer.medley.jp/", text: "MEDLEY Developer Portal" },
        { href: "https://twitter.com/medley_dev", text: "メドレー ディベロッパー公式 (@medley_dev) on X" },
      ],
    },
    {
      name: "株式会社タイミー",
      description: (
        <>
          株式会社タイミーは「『はたらく』を通じて人生の可能性を広げるインフラをつくる」をミッションに掲げ、スキマバイトアプリ「タイミー」などの事業を展開しております。
          サービスリリースから約5年経過した現在、
      ...
      logoLink: "https://timee.notion.site/timee/Timee-Product-Org-Entrance-Book-b7380eb4f6954e29b2664fe6f5e775f9",
      links: [
        { href: "https://timee.notion.site/timee/Timee-Product-Org-Entrance-Book-b7380eb4f6954e29b2664fe6f5e775f9", text: "プロダクトエントランスブック", },
        { href: "https://productpr.timee.co.jp/m/m080509565c68/hashtag/4945140", text: "エンジニア向け成長支援制度の紹介" },
        { href: "https://product-recruit.timee.co.jp/", text: "エンジニア採用ページ" },
      ],
    },
    {
      ...
      links: [
        ...
        { href: "https://engineer.toggle.co.jp/", text: "エンジニア向け ハンドブック" },
    ...
    },
    {
      ...
      description: (
        <>
          EARTHBRAINは土木業界をDXするスタートアップ企業です。 土木業界は日本だけでも24兆円/年、世界では200兆円超/年の巨大な市場です。ただ、デジタル技術を用いた施工は普及しておらず”黎明期”と言えるフェーズです。 創業2年目ですが、日本だけではなく既に世界20カ国以上で使われているプロダクトを提供しているグローバルな企業です。日本から世界を変える挑戦を一緒に行いましょう！
        </>
      ),
      ...
      links: [
        ...
        { href: "https://earthbrain.notion.site/EARTHBRAIN-Tech-3775fb71b41342aebf0aee6848d722bd", text: "エンジニア採用特設サイト" },
      ],
    },
    {
      ...
      description: (
        <>
          Google Cloudは、最高クラスのインフラストラクチャ、プラットフォーム、インダストリーソリューションと専門知識により、企業のデジタルトランスフォーメーション（DX）を加速します。Googleの最先端技術を活用したエンタープライズグレードのソリューションを、業界で最もクリーンなクラウド上で提供しています。200以上の国と地域のお客様が、成長を実現し、重要なビジネス上の課題を解決するための信頼できるパートナーとして、Google Cloudを利用しています。
        </>
      ),
      ...
      links: [
        { href: "", text: "", },
        { href: "https://cloud.google.com/innovators?hl=ja", text: "Innovators プログラム" },
        { href: "https://cloudonair.withgoogle.com/events/innovators-live-jp", text: "Innovators Live Japan" },
      ],
    },
    {
      name: "株式会社LayerX",
  ...
  Silver: [
    {
      ...
      description: (
        <>
          「先端技術を、経済実装する。」をミッションに活動している株式会社アイデミーでは、オンラインAI/DXラーニングサービス「Aidemy」などの自社プロダクトの開発において、フロントエンドからバックエンドまで統一した言語として TypeScript を採用している「TypeScript Company」です。
    ...
    },
    {
      ...
      description: (
        <>
          3Dの技術を強みとして、建築業界のDXを推進してきた建築系スタートアップです。
      ...
      links: [
        ...
        { href: "https://ddddbox.app/", text: "建築設計クラウドサービス DDDDbox" },
        { href: "https://a-spec.lixil.com/", text: "パブリックトイレ自動設計サービス A-SPEC" },
      ],
    },
    {
      name: "レバテック株式会社",
    ...
    },
    {
      ...
      links: [
        ...
        { href: "https://engineer.linc-well.com/", text: "エンジニア採用サイト" },
      ],
    },
    {
      name: "株式会社ビットキー",
    ...
    },
    {
      ...
      logoLink: "",
      links: [
        { href: "https://www.optim.co.jp/corporate/outline", text: "OPTiMの事業紹介", },
    ...
    },
    {
      ...
      description: (
        <>
          DMMでは、会員数4,101万人（2023年2月時点）を誇る総合サービスサイト「DMM .com」を運営しています。現在、動画配信・電子書籍・3Dプリント・web3・AIなど60以上の事業を幅広く展開し、コーポレートメッセージ「誰もが見たくなる未来。」とともに、新しい技術・サービスを追及しながら、領域を問わず挑戦を続けています。
        </>
      ),
      logoImage: "/sponsors/dmm_horizontal.png",
      logoLink: "https://dmm-corp.com/",
      links: [
        { href: "https://dmm-corp.com/recruit/engineer/1859/", text: "フロントエンドエンジニア（オープンポジション）", },
        { href: "https://dmm-corp.com/recruit/engineer/1860/", text: "フロントエンドエンジニア_テックリード（オープンポジション）" },
        { href: "", text: "" },
      ],
    },
    {
  ...
  Bronze: [
    ...
    },
    {
      ...
      logoImage: "/sponsors/ROUTE06-logo-v1.5.pdf",
      logoLink: "",
      links: [
        { href: "", text: "", },
        { href: "", text: "" },
  ...
  Coffee: [
    {
      ...
      logoLink: "",
      links: [
        { href: "https://kakehashi-dev.hatenablog.com/", text: "KAKEHASHI Tech Blog", },
        { href: "https://recruit.kakehashi.life/engineer", text: "KAKEHASHI RECRUTHING SITE" },
        { href: "https://twitter.com/kakehashi_dev", text: "X カケハシ技術広報(@kakehashi_dev)" },
      ],
    },
  ],
  Beer: [
    {
      ...
      description: (
        <>
          「日本企業が世界を変える時代をつくる」というミッションのもと、日本企業からイノベーションを起こすべくクラウドセキュリティの SaaS を提供しております。
